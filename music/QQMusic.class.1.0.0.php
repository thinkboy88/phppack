 ...
 */
//music = new QQMusic();
//echo $music -> search('告白气球') -> getSingerName(0);
class QQMusic {
    private $url;
    private $callback;
    private $songs;
    ...
    public function __construct() {
        ...
        $this -> url = [
            ...
            //随机50首
            'rand' => 'https://c.y.qq.com/v8/fcg-bin/fcg_v8_toplist_cp.fcg?g_tk=5381&uin=0&format=json&inCharset=utf-8&outCharset=utf-8¬ice=0&platform=h5&needNewCode=1&tpl=3&page=detail&type=top&topid=36&_=1520777874472',
            //新歌100首
